...
export default function Footer() {
  ...
  return (
    <footer
      className={`${exo.className} flex flex-col w-full mx-auto px-10 py-5 md:py-10 sm:px-6 lg:px-8 bg-blue-500 absolute bottom-0 h-[375px] md:h-[275px] lg:h-[250px]`}
    >
      <div className="flex flex-col lg:flex-row items-center justify-between gap-4">
        ...
        {!isAuthenticated ? (
          <div
            className={`${sailorsRegular.className} text-white-500 text-base text-center justify-between flex flex-col md:flex-row md:w-[660px]`}
          >
            <Link href="/">Home</Link>
