    ...
    <div className="mx-auto w-full h-full flex flex-col">
      ...
      >
        ...
        <div className="col-span-2 relative">
          {error && (
            <div className="bg-red-500 text-white-500 px-2 py-1 flex justify-start items-center rounded-lg font-medium absolute left-0">
              {error}
            </div>
          )}
          <div className="absolute right-0 col-span-2">
            {isLoading ? (
              ...
              <Button text="Log In" type="submit" disabled={isLoading}></Button>
            )}
          </div>
        </div>

        <p className="flex justify-end col-span-2 mt-8">
