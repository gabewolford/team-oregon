...
import blueLogo from "../../../public/images/team-oregon-logo-blue.png";
...
export default function Navbar() {
  ...
  return (
    <header
      className={`fixed flex flex-wrap sm:justify-start sm:flex-nowrap z-40 w-full bg-lightblue-500 text-sm py-3 sm:py-0 ${
        isAdminPath ? "hidden" : ""
      }`}
    >
      <nav
        className={`${sailorsRegular.className} relative w-full mx-auto px-4 sm:flex sm:items-center sm:justify-between sm:px-6 lg:px-8`}
        aria-label="Global"
      >
        <div className="sm:hidden flex items-center justify-between">
          ...
          <div className="sm:hidden">
            <button
              type="button"
              className="hs-collapse-toggle p-0 inline-flex justify-center items-center rounded-md  bg-white align-middle focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-white focus:ring-cyan-420 transition-all text-sm"
        ...
        <div className="hidden sm:block items-center justify-between">
          <div className="flex sm:w-[250px] lg:w-[368px]">
            ...
            <Link className="" href="/">
              <Image
                src={blueLogo}
                className="w-[250px] lg:w-[368px] h-auto"
                alt="Team Oregon logo"
                priority={true}
              ></Image>
            </Link>
