        ...
        <div className="flex flex-col max-w-[650px] mx-auto px-10 gap-2">
          <div className="flex flex-row gap-4">
            ...
            <div className="flex flex-row items-center space-x-2">
              ...
              <Instagram color={'#0163AA'} linkTo={'https://www.instagram.com/roddapaint/'} />
              <Facebook color={'#0163AA'} linkTo={'https://www.facebook.com/roddapaint/'} />
            </div>
          </div>
            ...
            <div className="flex flex-col pl-8 md:pl-0 md:flex-row justify-around text-sm md:text-base">
              <div className="flex flex-col">
                <ul className="list-disc">
                  <li>Respect for <strong>People</strong></li>
                  <li>Commitment to <strong>Integrity</strong></li>
                  <li>Industry Leading <strong>Service</strong></li>
                  <li>Foster <strong>Innovation</strong></li>
                </ul>
              </div>
              <div className="flex flex-col">
                <ul className="list-disc">
                  <li>Focusing on <strong>Quality</strong></li>
                  <li>Clarity of <strong>Communication</strong></li>
                  <li>Social <strong>Responsibility</strong></li>
                  <li>Promote <strong>Success</strong></li>
                </ul>
              </div>
            </div>
          </div>
